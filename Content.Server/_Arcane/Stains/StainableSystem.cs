...
namespace Content.Server._Arcane.Stains;
...
public sealed partial class StainableSystem : SharedStainableSystem
{
    ...
    protected override void StainForensics(Entity<Shared._Arcane.Stains.StainableComponent> ent, Entity<SolutionComponent> solution)
    {
        _tag.AddTag(ent.Owner, ForensicScannerSystem.DNASolutionScannableTag);
    }

    protected override void WashingForensics(Entity<Shared._Arcane.Stains.StainableComponent> ent, Entity<SolutionComponent> solution, EntityUid washingMachine)
    {
