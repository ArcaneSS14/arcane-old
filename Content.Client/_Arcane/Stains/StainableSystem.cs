...
public sealed partial class StainableSystem : SharedStainableSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<Shared._Arcane.Stains.StainableComponent, AppearanceChangeEvent>(OnAppearanceChanged);
        SubscribeLocalEvent<Shared._Arcane.Stains.StainableComponent, GetEquipmentVisualsEvent>(OnClothingVisuals, after: [typeof(ClientClothingSystem)]);
        SubscribeLocalEvent<Shared._Arcane.Stains.StainableComponent, GetInhandVisualsEvent>(OnItemVisuals, after: [typeof(ItemSystem)]);

        _layerPrefix = _reflection.GetEnumReference(StainVisualLayers.Layer);
    }

    private void OnAppearanceChanged(Entity<Shared._Arcane.Stains.StainableComponent> ent, ref AppearanceChangeEvent args)
    {
    ...
    private void OnClothingVisuals(Entity<Shared._Arcane.Stains.StainableComponent> ent, ref GetEquipmentVisualsEvent args)
    {
    ...
    private void OnItemVisuals(Entity<Shared._Arcane.Stains.StainableComponent> ent, ref GetInhandVisualsEvent args)
    {
    ...
    private IEnumerable<(string, PrototypeLayerData)> UpdateVisuals(Entity<Shared._Arcane.Stains.StainableComponent> ent, List<PrototypeLayerData> layers, object? identifier = null)
    {
